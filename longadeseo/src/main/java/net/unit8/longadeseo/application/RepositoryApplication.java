...
public class RepositoryApplication extends WebApplication {
	protected void init() {
		super.init();
		addComponentInstantiationListener(new GuiceComponentInjector(this, new LongadeseoModule()));
		mountBookmarkablePage("/manual", ManualPage.class);
		mountBookmarkablePage("/plugin/list", PluginListPage.class);
	}
